@category1 = Category.create(name:"レディ-ス")
...
category7s.each.with_index(1) do |category7,i|
  level2_var="@category7_#{i}"
  level2_val= @category7.children.create(name:"#{category7[:level2]}")
  eval("#{level2_var} = level2_val")
  category7[:level2_children].each do |level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category8s.each.with_index(1) do |category8,i|
  level2_var="@category8_#{i}"
  level2_val= @category8.children.create(name:"#{category8[:level2]}")
  eval("#{level2_var} = level2_val")
  category8[:level2_children].each do |level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category9s.each.with_index(1) do |category9,i|
  level2_var="@category9_#{i}"
  level2_val= @category9.children.create(name:"#{category9[:level2]}")
  eval("#{level2_var} = level2_val")
  category9[:level2_children].each do |level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category10s.each.with_index(1) do |category10,i|
  level2_var="@category10_#{i}"
  level2_val= @category10.children.create(name:"#{category10[:level2]}")
  eval("#{level2_var} = level2_val")
  category10[:level2_children].each do |level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category11s.each.with_index(1) do |category11,i|
  level2_var="@category11_#{i}"
  level2_val= @category11.children.create(name:"#{category11[:level2]}")
  eval("#{level2_var} = level2_val")
  category11[:level2_children].each do |level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category12s.each.with_index(1) do |category12,i|
  level2_var="@category12_#{i}"
  level2_val= @category12.children.create(name:"#{category12[:level2]}")
  eval("#{level2_var} = level2_val")
  category12[:level2_children].each do |level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end
...
category13s.each.with_index(1) do |category13,i|
  level2_var="@category13_#{i}"
  level2_val= @category13.children.create(name:"#{category13[:level2]}")
  eval("#{level2_var} = level2_val")
  category13[:level2_children].each do |level2_children_val|
    eval("#{level2_var}.children.create(name:level2_children_val)")
  end
end